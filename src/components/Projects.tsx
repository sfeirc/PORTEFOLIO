          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6 mb-20">
            ...
            >
              ...
              <div className="relative glass p-8 rounded-lg border border-white/10 hover:border-white/20 transition-colors duration-300">
                ...
                <p className="text-gray-300 mb-6">
                  Développement et déploiement d'un simulateur d'entretien avec l'API Conversationnel AI d'Elevenlabs, utilisant Next.js et React.js pour aider les étudiants à préparer leurs entretiens.
                </p>
            ...
            >
              ...
              <div className="relative glass p-8 rounded-lg border border-white/10 hover:border-white/20 transition-colors duration-300">
                <div className="flex items-center gap-4 mb-6">
                  ...
                  <div className="flex-1">
                    <div className="flex items-center gap-2">
                      ...
                      <h3 className="text-xl font-semibold bg-clip-text text-transparent bg-gradient-to-r from-white to-white/80">
                        Stage - Chatbot Support Étudiant
                      </h3>
                    </div>
                ...
                <p className="text-gray-300 mb-6">
                  Développement et déploiement d'un chatbot de support étudiant basé sur l'API GPT-4 d'OpenAI, intégrant une architecture RAG et une base de données vectorielle pour un accès rapide aux ressources académiques, réduisant le temps de recherche de 40%.
                </p>
